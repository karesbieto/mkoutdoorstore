<?php  
	...
	if(isset($_SESSION['user'])) {
		...
		$status_id = 1; //default value is pending
		...
		try {
		    ...
		    $mail->Body    = 'Thank you for purchasing at <b>MK Outdoor Store.</b><br><br>The total amount to be paid is <b>&#8369;</b>' .$totalAmount.'.<br>Your item will be delivered to you. Please pay the exact amount upon the arrival of the item.';
